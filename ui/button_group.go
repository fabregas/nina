...
func (g *buttonGroupBuilder) build() *nn.Element {
	g.el.Attr("data-orientation", g.orientationAttr)

	switch g.orientationAttr {
	case "horizontal":
		g.el.Class("*:data-slot:rounded-r-none [&>[data-slot]:not(:has(~[data-slot]))]:rounded-r-4xl! [&>[data-slot]~[data-slot]]:rounded-l-none [&>[data-slot]~[data-slot]]:border-l-0")
	case "vertical":
		g.el.Class("flex-col *:data-slot:rounded-b-none [&>[data-slot]:not(:has(~[data-slot]))]:rounded-b-4xl! [&>[data-slot]~[data-slot]]:rounded-t-none [&>[data-slot]~[data-slot]]:border-t-0")
...
func ButtonGroupSeparator() *buttonGroupSeparatorBuilder {
	el := Separator().
		...
		Class("relative self-stretch bg-input data-horizontal:mx-px data-horizontal:w-auto data-vertical:my-px data-vertical:h-auto").El()
...
func (s *buttonGroupSeparatorBuilder) build() *nn.Element {
	return s.el
}
