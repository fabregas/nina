...
func Input() *inputBuilder {
	...
	b.baseBuilder = base(b, "input")
	b.Attr("data-slot", "input").
...
func (i *inputBuilder) TypeText() *inputBuilder     { i.Attr("type", "text"); return i }
func (i *inputBuilder) TypePassword() *inputBuilder { i.Attr("type", "password"); return i }
func (i *inputBuilder) TypeEmail() *inputBuilder    { i.Attr("type", "email"); return i }
func (i *inputBuilder) TypeNumber() *inputBuilder   { i.Attr("type", "number"); return i }

func (i *inputBuilder) NoArrows() *inputBuilder {
	i.Class("[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none")
	return i
}
...
func (i *inputBuilder) build(ctx *buildContext) {
	if i.value != nil {
		ctx.Props.Attr("value", *i.value)
	}
}
